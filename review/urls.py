...
from review.views import show_reviews, get_review_json, create_review_ajax, remove_ajax, get_user_review, vote_review, delete_review_flutter, get_user_role, vote_review_flutter
...
urlpatterns = [
    ...
    path('vote_flutter/', vote_review_flutter, name='vote_review_flutter'),
